...
public class ISOTransferController {
    private static final Logger logger = LoggerFactory.getLogger(ISOTransferController.class);
    ...
    public String buildISO(String accNumber,String pin, int amount,String beneficiaryBankCode, String accNumberReceiver){
...
//            System.out.println(new String(result));
            logger.info("Built ISO Message for Transfer");
        }catch (Exception e){
