...
public class ISOPurchaseInquiryController {
    private static final Logger logger = LoggerFactory.getLogger(ISOPurchaseInquiryController.class);
...
//            System.out.println(new String(result));
            logger.info("Built ISO Message for Purchase Inquiry");
        }catch (Exception e){
