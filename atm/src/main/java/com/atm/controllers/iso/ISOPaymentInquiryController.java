...
public class ISOPaymentInquiryController {
    private static final Logger logger = LoggerFactory.getLogger(ISOPaymentInquiryController.class);
    ...
    public String buildISO(String accNumber,String pin, int amount,String forwardingInstitutionCode
            , String virtualAccount,String server){
        ...
        try {
            ...
            //payment inquiry processing code
            isoMsg.set(3, "380000");
...
//            System.out.println(new String(result));
            logger.info("Built ISO Message for Payment Inquiry");
        }catch (Exception e){
