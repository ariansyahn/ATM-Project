...
public class ISOWithdrawController {
    private static final Logger logger = LoggerFactory.getLogger(ISOWithdrawController.class);
...
//    private ISOController isoController = new ISOController();
    ...
    public String buildISO(String accNumber,String pin, int amount,String server){
...
//            isoController.printISOMessage(isoMsg);
            result = isoMsg.pack();
            logger.info("Built ISO Message for Cash Withdrawal");
