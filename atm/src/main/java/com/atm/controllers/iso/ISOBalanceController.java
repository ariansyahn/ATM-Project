...
public class ISOBalanceController {
    private static final Logger logger = LoggerFactory.getLogger(ISOBalanceController.class);
...
//    private ISOController isoController = new ISOController();
    ...
    public String buildISO(String accNumber,String pin,String server){
...
//            System.out.println(new String(result));
            logger.info("Built ISO Message to Check Balance");
        }catch (Exception e){
