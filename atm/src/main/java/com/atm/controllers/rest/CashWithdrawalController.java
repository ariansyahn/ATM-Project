...
import com.atm.dao.CashWithdrawalDao;
...
public class CashWithdrawalController {
    ...
    public String cashWithdraw(@RequestBody String message){
        ...
        try{
            ...
            CashWithdrawalDao cashWithdrawalDao = new CashWithdrawalDao(jdbcTemplate);
            response = cashWithdrawalDao.cashWithdrawal(accNumber,pinNumber,amount,server,port);
        }catch (Exception e){
